...
function createReducer(baseState) {
  ...
  _reducer_registry.default.setReducers(Object.assign.apply(Object, [{}].concat(reducers)));

  var baseReducer = (0, _redux.combineReducers)(_reducer_registry.default.getReducers()); // Root reducer wrapper that listens for reset events.
